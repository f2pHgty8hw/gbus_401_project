...
collapse (mean) lsat* gpa* (firstnm) school apps* offers* matrics* accr yield merit_aid-stud_aid_100toX t14 accr2 gpa75-lsat25 (sum) fee_waived got_merit_aid attend urm admit* gpa_* lsat_* (count) user_id, by(school_id year)




collapse (firstnm) accr accr2, by(school_id year)
